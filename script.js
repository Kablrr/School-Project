...
generateAvatarBtn.addEventListener("click", () => {
  // Add "smiling" to always generate a smiling avatar
  const prompt = `A smiling ${ageSelect.value} ${raceSelect.value} colonial student wearing ${outfitSelect.value}, with ${hatSelect.value}, holding ${accessorySelect.value}, standing in a ${backgroundSelect.value}, oil painting, 18th century`;
